<div class="tags index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('tagger_id');?></th>
			<th><?php echo $this->Paginator->sort('tagged_id');?></th>
			<th><?php echo $this->Paginator->sort('tagtime');?></th>
			<th><?php echo $this->Paginator->sort('how');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $tag['Tag']['tagger_id']; ?>&nbsp;</td>
		<td><?php echo $tag['Tag']['tagged_id']; ?>&nbsp;</td>
		<td><?php echo $tag['Tag']['tagtime']; ?>&nbsp;</td>
		<td><?php echo $tag['Tag']['how']; ?>&nbsp;</td>
		<td class="actions">
